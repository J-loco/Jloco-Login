 ...
 * the exchange key, issued by "JLocoGameServer", whose subject is the account name and "ip" claim the
 * player's address. JLoco-Game creates it in GameClient#switchCharacter.
 */
public final class CharacterSwitchToken {

    static final String ISSUER = "JLocoGameServer";
